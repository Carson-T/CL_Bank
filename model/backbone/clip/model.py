...
class CLIP(nn.Module):
    ...
    def forward(self, image, text, img_adapter_list=None, text_adapter_list=None):
        image_features = self.encode_image(image, img_adapter_list)
        text_features = self.encode_text(text, text_adapter_list)
        # normalized features
